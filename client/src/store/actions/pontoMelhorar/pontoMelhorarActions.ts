...
const setGetPontosMelhorar = (
  pontosMelhorar: PontoMelhorar[]
): PontoMelhorarActionsTypes => ({
  type: "GET_PONTOS_MELHORAR",
  pontosMelhorar,
});
const setGetPontosMelhorarErro = (
  error: string
): PontoMelhorarActionsTypes => ({ type: "GET_PONTOS_MELHORAR_ERROR", error });
const setGetPontosMelhorarLoading = (
  loading: boolean
): PontoMelhorarActionsTypes => ({
