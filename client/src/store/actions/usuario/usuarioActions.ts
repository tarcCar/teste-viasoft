...
const setGetAllUsuarios = (usuarios: Usuario[]): UsuarioActionsTypes => ({
  type: "GET_USUARIOS",
  usuarios,
});
const setGetAllUsuarioErro = (error: string): UsuarioActionsTypes => ({
  type: "GET_USUARIOS_ERROR",
  error,
});
const setGetAllUsuariosLoading = (loading: boolean): UsuarioActionsTypes => ({
  type: "LOADING_GET_USUARIOS",
  loading,
});

const setSaveUsuario = (usuario: Usuario): UsuarioActionsTypes => ({
  type: "SAVE_USUARIO",
  usuario,
});
const setSaveUsuarioErro = (error: string): UsuarioActionsTypes => ({
  type: "SAVE_USUARIO_ERROR",
  error,
});
const setSaveUsuarioLoading = (loading: boolean): UsuarioActionsTypes => ({
...
export const saveUsuarioAction = (usuario: Usuario): any => async (
  dispatch: any
) => {
  try {
