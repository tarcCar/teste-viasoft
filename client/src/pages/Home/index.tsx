...
import DialActionButtonHome from "../../components/DialActionButtonHome";
  ...
  return (
    <>
      <Container component="main" maxWidth="lg">
        <Grid>
          <Grid item>
            <CardDataTableFeedback
              titulo="Feedback que você fez"
          ...
          <Grid item>
            <CardDataTableFeedback
              titulo="Feedback que foram feitos para você"
              feedBacks={feedbacksParaUsuario}
            />
          </Grid>
        </Grid>
      </Container>
      <DialActionButtonHome />
    </>
  );
};
